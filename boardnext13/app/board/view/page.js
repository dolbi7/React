             ...
             <div className="main">
                ...
                <div className="boardView">
                    ...
                    <div className="likeForm" style={{width:'30%',height:'auto',margin:'auto',cursor:'pointer'}}>
                        ...
                        <span onClick={likeView} className={styles.likeClick} style={likeStyle}>좋아요</span> {/* 클릭하면 좋아요 등록/취소 */}
                        <span onClick={disLikeView} className={styles.dislikeClick} style={dislikeStyle}>싫어요</span>&nbsp;{/* 클릭하면 싫어요 등록/취소 */}
                ...
                <div className="bottom_menu">
                    {
                        pre_seqno !== '0' && <a href={`/board/view?seqno=${pre_seqno}&page=${page}&keyword=${keyword}`}>이전글▼</a>
                    }
                    &nbsp;&nbsp;
                    <a href={`/board/list?page=${page}&keyword=${keyword}`}>목록보기</a>
                    &nbsp;&nbsp;                    
                    {
                        next_seqno !== '0' && <a href={`/board/view?seqno=${next_seqno}&page=${page}&keyword=${keyword}`}>다음글▲</a>
                    }
                    &nbsp;&nbsp; 
                    ...
                    &nbsp;&nbsp; 
                    {
                        ...
                        <a href={`/board/modify?seqno=${seqno}&page=${page}&keyword=${keyword}`}>글 수정</a>
                    } 
                    &nbsp;&nbsp;   
                    {
                        emailCookie === email.email && 
